...
echo "Latest Version of Rustdesk Server Pro: $RDLATEST"
RDCURRENT=$(/usr/bin/hbbr --version | sed -r 's/hbbr (.*)/\1/')
echo "Installed Version of Ruskdesk Server Pro: $RDCURRENT"
...
echo "Stoping Rustdesk-HBBS Service..."
...
echo "Starting Rustdesk-HBBS Service..."
sudo systemctl start rustdesk-hbbs.service
echo "Starting Rustdesk-HBBR Service..."
